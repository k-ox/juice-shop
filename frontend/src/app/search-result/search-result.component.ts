...
export class SearchResultComponent implements OnDestroy, AfterViewInit {
  ...
  filterTable () {
    ...
    if (queryParam) {
      ...
      this.searchValue = '' // vuln-code-snippet vuln-line localXssChallenge xssBonusChallenge
      //this.searchValue = this.sanitizer.bypassSecurityTrustHtml(SqueryParam) // vuln-code-snippet vuln-line localXssChallenge xssBonusChallenge
